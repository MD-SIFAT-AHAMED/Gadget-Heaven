...
const Banner = () => {
    return (
        <div className='max-w-screen-xl mx-auto mb-40 md:mb-80 lg:mb-90 xl:mb-115'>
            <div className='relative bg-[#9538E2] rounded-b-xl space-y-6 text-center pt-20 pb-40 lg:pb-60 xl:pb-80'>
